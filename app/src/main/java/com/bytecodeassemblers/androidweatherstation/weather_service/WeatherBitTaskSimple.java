...
public class WeatherBitTaskSimple extends AsyncTask<String,Void, WeatherBitMap> {
    ...
    public WeatherBitTaskSimple(Activity activity, MimageLoader image){
    ...
    protected void onPreExecute() {
        ...
        weatherBitTempOnView = activity.findViewById(R.id.temp);
    ...
    protected void onPostExecute(WeatherBitMap weatherBitMap) {
        ...
        weatherBitTempOnView.setText(weatherBitMap.main.getTemp());
